export const TextConstants = {
    ...
    TEXT__START_FREE_TRIAL: (duration: number) =>
        `Start Free Trial - ${duration} DAYS`,
    ...
    TEXT__USER_DOES_NOT_EXIST:
        "Hmm, we couldn't find a user with that email address.",
    ...
    TEXT__RESET_PASSWORD_EMAIL_SENT:
    ...
    ERROR__EMAIL_ALREADY_IN_USE:
        "This email is in use. Please log in to continue.",
};
