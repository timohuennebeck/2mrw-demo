    ...
    return (
        <header className="min-h-12 border-b border-neutral-200 bg-white">
            <div className="flex items-center justify-between px-4 py-2.5">
                ...
                <div className="flex items-center space-x-4">
                    <button className="flex items-center gap-2 rounded-md border border-neutral-300 px-3 py-1 text-xs">
                        Feedback
                    </button>
                    <button className="flex items-center gap-2 rounded-md border border-neutral-300 px-3 py-1 text-xs">
                    ...
                    <CircleUserRound className="text-neutral-600" strokeWidth={1.25} size={16} />
                </div>
            </div>
        </header>
    );
