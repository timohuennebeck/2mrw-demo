        ...
        <div className="relative rounded-md border p-8">
            <div className="mb-6">
                <div className="skeleton-header mb-4">
                    ...
                    <div className="mb-2 h-5 w-1/2 rounded bg-neutral-200"></div>
                    <div className="h-4 w-1/3 rounded bg-neutral-200"></div>
                </div>

                <div className="skeleton-pricing mb-4">
                    {/* Placeholder for PlanPricing */}
                    <div className="mb-2 h-8 w-1/4 rounded bg-neutral-200"></div>
                    <div className="h-4 w-1/5 rounded bg-neutral-200"></div>
                </div>
